  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-slate-50 to-slate-100 text-slate-800">
      ...
      <div className="flex-1 flex flex-col">
        <div className="flex items-center justify-end px-4 md:px-6 py-3 md:py-4 bg-white border-b border-slate-100 ml-0 md:ml-0 pl-14 md:pl-6">
        ...
        <main className="p-4 md:p-8 space-y-6 md:space-y-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-slate-800">Welcome, Admin</h1>
              <p className="text-slate-500 mt-1 text-sm md:text-base">Overview of projects, students and AI suggestions</p>
            </div>
...
function StatCard({ label, value, icon }) {
  return (
    <div className="flex items-center gap-3 md:gap-4 bg-white p-3 md:p-4 rounded-2xl shadow-sm hover:shadow-lg transition-all hover:-translate-y-1 min-w-0">
      <div className="p-2 md:p-3 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-inner flex-shrink-0">{icon}</div>
      <div className="min-w-0">
        <div className="text-xs text-slate-500 truncate">{label}</div>
        <div className="text-lg md:text-2xl font-bold text-slate-800">{value}</div>
      </div>
    </div>
  )
}
